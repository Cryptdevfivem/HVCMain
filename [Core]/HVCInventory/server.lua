...
AddEventHandler('AQUARP:FetchPersonalInventory', function()
    local source = source
...
RegisterNetEvent('AQUARP:FetchTrunkInventory')
...
RegisterNetEvent('AQUARP:FetchHouseInventory')
...
RegisterNetEvent('AQUARP:CloseLootbag')
AddEventHandler('AQUARP:CloseLootbag', function()
    local source = source
    for i,v in pairs(LootBagEntities) do 
...
function CloseInv(source)
    TriggerClientEvent('AQUARP:InventoryOpen', source, false, false)
end
