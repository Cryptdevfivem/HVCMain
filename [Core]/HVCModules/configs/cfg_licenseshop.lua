...
cfglicense.licenseshop = {
    legal = {
        {name = "Coal", price = 50000, group = "coal"},
        {name = "Iron", price = 125000, group = "iron"},
        {name = "Gold", price = 3300000, group = "gold"},
        {name = "Diamond", price = 7000000, group = "diamond"},
        {name = "Ethereum", price = 15000000, group = "ethereum"},
        {name = "Oil", price = 35000000, group = "oil"},
    },
    illegal = {
        {name = "Weed", price = 100000, group = "weed"},
        {name = "Cocaine", price = 350000, group = "cocaine"},
